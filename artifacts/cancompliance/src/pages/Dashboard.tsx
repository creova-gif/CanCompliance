...
const ROLE_CONFIG: Record<string, {
  ...
  "Auditor": {
    ...
    subtitle: "Audit trail, finding tracker, evidence portal, control mapper, document scanner",
  ...
  "Business Owner": {
    ...
    subtitle: "Industry pack, fine exposure, scale advisor, grant finder, jurisdiction setup",

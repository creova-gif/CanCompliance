...
export const runComplianceCheck = async (
  complianceCheckBody: ComplianceCheckBody,
  options?: RequestInit,
): Promise<ComplianceCheckResult> => {
  return customFetch<ComplianceCheckResult>(getRunComplianceCheckUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(complianceCheckBody),
  });
};

export const getRunComplianceCheckMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<ComplianceCheckBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type RunComplianceCheckMutationResult = NonNullable<
  Awaited<ReturnType<typeof runComplianceCheck>>
>;
export type RunComplianceCheckMutationBody = BodyType<ComplianceCheckBody>;
...
export const getScanUrlUrl = () => {
  return `/api/compliance/scan-url`;
};
...
export const scanUrl = async (
  ...
  return customFetch<ScanUrlResult>(getScanUrlUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
